/**
 * screen_diary.cpp — Diary list screen (stub)
 *
 * Will show a scrollable list of diary entries. Placeholder for now.
 *
...
void create() {
    ...
    lv_label_set_text(placeholder, "Le pagine del diario sono vuote...\n(in sviluppo)");
    ...
    Serial.println("[DIARY] Screen created (stub)");
}
