/**
 * screen_conversation.cpp — Chat/conversation screen (stub)
 *
 * Will display conversation history and text input for chatting with the pet.
 * Currently shows a placeholder UI.
 *
...
static void back_btn_cb(lv_event_t* e) {
    (void)e;
    Serial.println("[CHAT] Back pressed");
...
void create() {
    ...
    lv_label_set_text(placeholder, "Chat con il tuo compagno...\n(in sviluppo)");
    ...
    Serial.println("[CHAT] Screen created (stub)");
}
