/**
 * screen_settings.cpp — Settings menu screen (stub)
 *
 * Will provide volume, brightness, WiFi, language, and reset options.
 * Placeholder for now.
 *
...
void create() {
    ...
    lv_label_set_text(title_label, "Impostazioni");
    ...
    lv_label_set_text(placeholder, "Impostazioni di sistema\n(in sviluppo)");
    ...
    Serial.println("[SETTINGS] Screen created (stub)");
}
